...
# the following imports almost certainly won't work!
from common.scn import StructuredControlNet
from common.scn_pf import PhaseControlNet

class SCN(StructuredControlNet):
    def __init__(self, *args, **kwargs):
        super(SCN, self).__init__(*args, **kwargs,
                                  net_arch=params.net_arch,
                                  act_fun=params.act_fun)

# class SCN_PF_NOnly(PhaseControlNet):
#     def __init__(self, *args, **kwargs):
#         super(SCN_PF_NOnly, self).__init__(*args, **kwargs,
#                                            net_arch=params.net_arch,
#                                            act_fun=params.act_fun,
#                                            PF_linear_also=False)
...
class SCN_PF_Both(PhaseControlNet):
    def __init__(self, *args, **kwargs):
        super(SCN_PF_Both, self).__init__(*args, **kwargs,
                                          net_arch=params.net_arch,
                                          act_fun=params.act_fun,
                                          PF_linear_also=True)
...
class MLP_Policy(FeedForwardPolicy):
    def __init__(self, *args, **kwargs):
        super(MLP_Policy, self).__init__(*args, **kwargs,
                                         net_arch=params.net_arch,
                                         act_fun=params.act_fun,
