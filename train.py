...
my_bullet_envs = ['HopperBulletPhase-v0',           # <-- the original, more test, based in pybullet internal Hopper
                  ...
                  'HalfCheetahPyBulletPhaseEnv-v0',
                  'AntPyBulletPhaseEnv-v0',
                  'HopperPyBulletPhaseEnv-v0',
                  'HumanoidPyBulletPhaseEnv-v0',
                  'Walker2DPyBulletPhaseHarderEnv-v0',
                  'HalfCheetahPyBulletPhaseHarderEnv-v0',
                  'AntPyBulletPhaseHarderEnv-v0',
                  'HopperPyBulletPhaseHarderEnv-v0',
                  'HumanoidPyBulletPhaseHarderEnv-v0'
                  'Walker2DPyBulletHarderEnv-v0',
                  'HalfCheetahPyBulletHarderEnv-v0',
                  'AntPyBulletHarderEnv-v0',
                  'HopperPyBulletHarderEnv-v0',
                  'HumanoidPyBulletHarderEnv-v0']

bullet_envs = ['Walker2DBulletEnv-v0',
               'HalfCheetahBulletEnv-v0',
               'AntBulletEnv-v0',
               'HopperBulletEnv-v0',
               'HumanoidBulletEnv-v0']

pybulletgym_envs = ['Walker2DPyBulletEnv-v0',
                    'HalfCheetahPyBulletEnv-v0',
                    'AntPyBulletEnv-v0',
                    'HopperPyBulletEnv-v0',
                    'HumanoidPyBulletEnv-v0']

mujoco_bullet_envs = ['Walker2DMuJoCoEnv-v0',
                      'HalfCheetahMuJoCoEnv-v0',
                      'AntMuJoCoEnv-v0',
                      'HopperMuJoCoEnv-v0',
                      'HumanoidMuJoCoEnv-v0']

roboschool_envs = ['RoboschoolHopper-v1',
                   'RoboschoolWalker2d-v1',
                   'RoboschoolHalfCheetah-v1',
                   'RoboschoolAnt-v1',
                   'RoboschoolHumanoid-v1']

roboschool_phase_envs = ['PhaseRoboschoolHopper-v1',
                         'PhaseRoboschoolWalker2d-v1',
                         'PhaseRoboschoolHalfCheetah-v1',
                         'PhaseRoboschoolAnt-v1',
                         'PhaseRoboschoolHumanoid-v1']

pfnn_list = bullet_envs + pybulletgym_envs + mujoco_bullet_envs + my_bullet_envs + roboschool_envs + roboschool_phase_envs
